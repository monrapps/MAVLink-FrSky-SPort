...
public:
  enum SerialId { 
    SOFT_SERIAL_PIN_2 = 2, SOFT_SERIAL_PIN_3 = 3, SOFT_SERIAL_PIN_4 = 4, SOFT_SERIAL_PIN_5 = 5, SOFT_SERIAL_PIN_6 = 6, SOFT_SERIAL_PIN_7 = 7,
...
private:
  ...
  const uint8_t SENSOR_ID_FLVSS = 0xA1;
  const uint8_t SENSOR_ID_FAS = 0x22;
  const uint8_t SENSOR_ID_GPS = 0x83; // ID of sensor. Must be something that is polled by FrSky RX
  const uint8_t SENSOR_ID_GPS2 = 0x1B;
  const uint8_t SENSOR_ID_RPM = 0xE4;
  const uint8_t SENSOR_ID_SP2UH = 0x45;
  const uint8_t SENSOR_ID_SP2UR = 0xC6;
  const uint8_t SENSOR_ID1 = 0x1B;
  const uint8_t SENSOR_ID2 = 0x0D;
  const uint8_t SENSOR_ID3 = 0x34;
  const uint8_t SENSOR_ID4 = 0x67;
  // Frsky-specific
  ...
  const uint16_t FR_ID_ADC1 =  0xF102;
  ...
  const uint16_t FR_ID_HOME_DIST = 0x0420;
  const uint16_t FR_ID_GPS_ALT = 0x0820;
  const uint16_t FR_ID_AIR_SPEED = 0x0A00;
  const uint16_t FR_ID_A3_FIRST = 0x0900; 	
  const uint16_t FR_ID_A4_FIRST = 0x0910;
